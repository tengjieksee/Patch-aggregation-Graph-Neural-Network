...
prev_cmd = "source activate /scratch/mo99/tsee0001/miniconda/conda/envs/tensornet_env_1_a40"
...
gpu_ids = [0,1,2,3,4,5,6,7,0,1,2,3]
commands = []
i_num = 0
for task in task_list:
    line = f'''{prev_cmd}&CUDA_VISIBLE_DEVICES={gpu_ids[i_num]} torchmd-train --conf ./yaml_folder/m_9-QM9_task_{i_num}.yaml --log-dir ./result_folder/output_m_9-QM9_task_{i_num}'''
