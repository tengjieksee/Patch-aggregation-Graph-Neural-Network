...
class aggregation_custom(torch.nn.Module):
    def __init__(self, hidden_channels):
        ...
        self.fc_all = torch.nn.Linear(int(16*3*3/2),16*3*3,bias=False)
    ...
    def forward(self, edge_index, factor, tensor, natoms):
        ...
        msg = msg.reshape(-1,16,16,3,3).reshape(-1,16,16*3*3).reshape(-1,16*3*3)
        ...
        var_num_patches = 2
        var_effective_patch_dim = int(16*3*3/2)
        
        e = msg#torch.permute(msg, (0,2,3,1))
        e = torch.reshape(e, (-1, 16*3*3))
        ##print(msg.shape)#[9954, 256, 3, 3]
        ...
        out = torch.reshape(out_lst,(-1,16*16,3,3))
        ##print(out.shape)
...
class Interaction(nn.Module):
    ...
    def __init__(
        ...
        self.tensor_message_passing_0 = aggregation_custom(256)
        self.tensor_message_passing_1 = aggregation_custom(256)
        self.tensor_message_passing_2 = aggregation_custom(256)
