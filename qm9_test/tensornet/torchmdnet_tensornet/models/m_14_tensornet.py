...
class aggregation_custom(torch.nn.Module):
    def __init__(self, hidden_channels):
        ...
        self.fc_all = torch.nn.Linear(int(self.factor*3*3/4),self.factor*3*3,bias=False)
    ...
    def forward(self, edge_index, factor, tensor, natoms):
        ...
        var_num_patches = 4#2
        var_effective_patch_dim = int(self.factor*3*3/4)
        ...
        out = torch.reshape(out,(-1,self.parts*self.factor*2,3,3))
