...
class aggregation_custom(torch.nn.Module):
    def __init__(self, hidden_channels):
        ...
        self.fc_all = torch.nn.Linear(int(256/2),256,bias=False)
    ...
    def forward(self, edge_index, factor, tensor, natoms):
        ...
        var_num_patches = 2
        var_effective_patch_dim = int(256/2)
        
        e = torch.permute(msg, (0,2,3,1))
        e = torch.reshape(e, (-1, 256))
        #print(e.shape)
        ...
        out = torch.reshape(out_lst,(-1,256,3,3))
